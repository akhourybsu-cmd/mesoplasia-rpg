...
const ZONE_SCENE := preload("res://scenes/world/caden/Commons.tscn")
const PLAYER_SCENE := preload("res://scenes/Player.tscn")
const RENDER_TOOL_PATH := "res://tools/art/render_caden_commons_runtime_v1.gd"
const GAMEPLAY_SIZE := Vector2i(640, 360)
const FULL_ZONE_SIZE := Vector2i(1024, 704)
...
func _render() -> void:
	...
	var specs: Array[Dictionary] = [
		_spec("commons_full_zone_after_v1_1024x704", Vector2(512, 352), NO_PLAYER, FULL_ZONE_SIZE, FULL_ZONE_SIZE, "Full Commons landscape and population"),
		_spec("commons_west_arrival_after_v1_640x360", Vector2(320, 352), Vector2(128, 352), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Town Square arrival and open west-east route"),
		_spec("commons_north_arrival_after_v1_640x360", Vector2(512, 256), Vector2(512, 128), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Residential arrival and open north-south route"),
		_spec("commons_route_junction_after_v1_640x360", Vector2(512, 352), Vector2(512, 352), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Route junction, meadow edge, and resident activity"),
		_spec("commons_quiet_green_after_v1_640x360", Vector2(704, 352), NO_PLAYER, GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Open Quiet Green and single rest pocket"),
		_spec("commons_south_green_after_v1_640x360", Vector2(512, 524), NO_PLAYER, GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Southern negative space and layered boundary"),
		_spec("commons_bench_player_front_after_v1_640x360", Vector2(640, 480), Vector2(660, 508), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Player below and in front of the quiet rest pocket"),
		_spec("commons_bench_player_behind_after_v1_640x360", Vector2(640, 480), Vector2(640, 444), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Player above and behind the quiet rest pocket"),
		_spec("commons_tree_player_front_after_v1_640x360", Vector2(800, 224), Vector2(800, 252), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Player below and in front of the Quiet Green tree"),
		_spec("commons_tree_player_behind_after_v1_640x360", Vector2(800, 224), Vector2(800, 188), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Player above and behind the Quiet Green tree"),
		_spec("commons_route_display_after_v1_1280x720", Vector2(512, 352), Vector2(512, 352), GAMEPLAY_SIZE, DISPLAY_SIZE, "Exact nearest-neighbor 2x route-junction view"),
	]
	...
	var manifest := {
		"schema": "caden-commons-runtime-screenshot-manifest-v1",
		"scope": "Commons runtime v1 selective source-art integration.",
		...
		"determinism": {"player_facing": "down", "player_animation": "idle_down", "player_animation_frame": 0, "npc_animation_frame": 0, "ambient_patrols": "paused at authored origins", "ui_state": "interaction prompt and dialogue UI hidden", "camera_smoothing": "disabled capture camera"},
		"reproduction": {
			"godot_arguments": "--path <repository> --rendering-method gl_compatibility --script res://tools/art/render_caden_commons_runtime_v1.gd -- --output-root <absolute-directory-outside-res>",
			"notes": "Every view instantiates the live Commons scene. The 1280x720 frame is an exact nearest-neighbor enlargement of the native route-junction view.",
		},
		"captures": entries,
	}
	var manifest_path := _output_root.path_join("commons_runtime_screenshot_manifest_v1.json")
...
func _manifest_entry(spec: Dictionary, output_path: String) -> Dictionary:
	...
	var output_size: Vector2i = spec["output_size"]
	return {
		"filename": output_path.get_file(), "description": spec["description"],
		"capture_dimensions": [capture_size.x, capture_size.y], "output_dimensions": [output_size.x, output_size.y],
		...
		"ui_visible": false, "sha256": FileAccess.get_sha256(output_path),
	}
...
func _resolve_output_root() -> String:
	...
	return OS.get_environment("CADEN_COMMONS_RUNTIME_OUTPUT_ROOT")
