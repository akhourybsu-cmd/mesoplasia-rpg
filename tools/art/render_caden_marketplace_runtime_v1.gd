...
const RENDER_TOOL_PATH := "res://tools/art/render_caden_marketplace_runtime_v1.gd"
...
func _render() -> void:
	...
	var specs: Array[Dictionary] = [
		_spec("marketplace_full_zone_after_v1_896x640", Vector2(448, 320), NO_PLAYER, FULL_ZONE_SIZE, FULL_ZONE_SIZE, "Full Marketplace composition"),
		_spec("marketplace_west_arrival_after_v1_640x360", Vector2(320, 320), Vector2(128, 320), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Wayfarer arrival and west aisle"),
		_spec("marketplace_primary_aisle_after_v1_640x360", Vector2(448, 320), Vector2(448, 320), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Primary commercial aisle and central crossroads"),
		_spec("marketplace_north_districts_after_v1_640x360", Vector2(448, 208), NO_PLAYER, GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Northwest and northeast vendor districts"),
		_spec("marketplace_south_districts_after_v1_640x360", Vector2(448, 448), NO_PLAYER, GAMEPLAY_SIZE, GAMEPLAY_SIZE, "South vendor and service districts"),
		_spec("marketplace_south_transition_after_v1_640x360", Vector2(448, 460), Vector2(448, 512), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Open Town Square forecourt"),
		_spec("marketplace_vendor_player_front_after_v1_640x360", Vector2(208, 448), Vector2(188, 520), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Player below and in front of the south vendor 07 anchor"),
		_spec("marketplace_vendor_player_behind_after_v1_640x360", Vector2(208, 448), Vector2(160, 456), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Player above and partially behind the south vendor 07 anchor"),
		_spec("marketplace_tree_player_front_after_v1_640x360", Vector2(640, 416), Vector2(848, 544), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Player below and in front of east perimeter tree"),
		_spec("marketplace_tree_player_behind_after_v1_640x360", Vector2(640, 416), Vector2(848, 480), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Player above and behind east perimeter tree"),
		_spec("marketplace_primary_display_after_v1_1280x720", Vector2(448, 320), Vector2(448, 320), GAMEPLAY_SIZE, DISPLAY_SIZE, "Exact nearest-neighbor 2x primary view"),
	]
	...
	var manifest := {
		"schema": "caden-marketplace-runtime-screenshot-manifest-v1",
		"scope": "Marketplace runtime v1 selective integration only.",
		...
		"reproduction": {
			"godot_arguments": "--path <repository> --rendering-method gl_compatibility --script res://tools/art/render_caden_marketplace_runtime_v1.gd -- --output-root <absolute-directory-outside-res>",
			"notes": "Every view instantiates the live Marketplace scene. The 1280x720 frame is nearest-neighbor resized from its native 640x360 capture state.",
		},
		"captures": entries,
	}
	var manifest_path := _output_root.path_join("marketplace_runtime_screenshot_manifest_v1.json")
...
func _resolve_output_root() -> String:
	...
	return OS.get_environment("CADEN_MARKETPLACE_RUNTIME_OUTPUT_ROOT")
