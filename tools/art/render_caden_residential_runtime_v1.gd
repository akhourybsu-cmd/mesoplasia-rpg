...
const RENDER_TOOL_PATH := "res://tools/art/render_caden_residential_runtime_v1.gd"
...
func _render() -> void:
	...
	var specs: Array[Dictionary] = [
		_spec("residential_full_zone_after_v1_1152x768", Vector2(576, 384), NO_PLAYER, FULL_ZONE_SIZE, FULL_ZONE_SIZE, "Full Residential composition and population"),
		_spec("residential_west_arrival_after_v1_640x360", Vector2(320, 384), Vector2(128, 384), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Town Square arrival and primary neighborhood road"),
		_spec("residential_primary_route_after_v1_640x360", Vector2(576, 384), Vector2(576, 384), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Primary road, residents, and Commons junction"),
		_spec("residential_north_homes_after_v1_640x360", Vector2(576, 208), NO_PLAYER, GAMEPLAY_SIZE, GAMEPLAY_SIZE, "North homes, aligned thresholds, and planted yards"),
		_spec("residential_south_homes_after_v1_640x360", Vector2(576, 592), NO_PLAYER, GAMEPLAY_SIZE, GAMEPLAY_SIZE, "South homes, household work areas, and planted edge"),
		_spec("residential_commons_transition_after_v1_640x360", Vector2(576, 588), Vector2(576, 640), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Open Commons exit and arrival marker clearance"),
		_spec("residential_doorstep_player_front_after_v1_640x360", Vector2(384, 256), Vector2(384, 280), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Player below and in front of the doorstep flower cluster"),
		_spec("residential_doorstep_player_behind_after_v1_640x360", Vector2(384, 256), Vector2(384, 224), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Player above and behind the doorstep flower cluster"),
		_spec("residential_laundry_player_front_after_v1_640x360", Vector2(400, 536), Vector2(400, 560), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Player below and in front of the laundry line"),
		_spec("residential_laundry_player_behind_after_v1_640x360", Vector2(400, 536), Vector2(400, 504), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Player above and behind the laundry line"),
		_spec("residential_primary_display_after_v1_1280x720", Vector2(576, 384), Vector2(576, 384), GAMEPLAY_SIZE, DISPLAY_SIZE, "Exact nearest-neighbor 2x primary view"),
	]
	...
	var manifest := {
		"schema": "caden-residential-runtime-screenshot-manifest-v1",
		"scope": "Residential runtime v1 selective source-art integration.",
		...
		"reproduction": {
			"godot_arguments": "--path <repository> --rendering-method gl_compatibility --script res://tools/art/render_caden_residential_runtime_v1.gd -- --output-root <absolute-directory-outside-res>",
	...
	var manifest_path := _output_root.path_join("residential_runtime_screenshot_manifest_v1.json")
...
func _resolve_output_root() -> String:
	...
	return OS.get_environment("CADEN_RESIDENTIAL_RUNTIME_OUTPUT_ROOT")
