...
const RENDER_TOOL_PATH := "res://tools/art/render_caden_wayfarer_production_landscape_v4.gd"
...
func _render() -> void:
	...
	if _output_root.begins_with(ProjectSettings.globalize_path("res://")):
		_fail("Production landscape evidence must be written outside res://.")
		return
	...
	var specs: Array[Dictionary] = [
		_evidence_spec(1, "wayfarer_full_zone_after_v4_1024x640", Vector2(512, 320), NO_PLAYER, FULL_ZONE_SIZE, FULL_ZONE_SIZE, "Complete revised zone"),
		_evidence_spec(2, "wayfarer_primary_gameplay_after_v4_640x360", Vector2(704, 400), NO_PLAYER, GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Primary road, yard edge, and rest-grove composition"),
		_evidence_spec(3, "wayfarer_inn_forecourt_after_v4_640x360", Vector2(320, 260), NO_PLAYER, GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Inn frontage and restrained worn apron"),
		_evidence_spec(4, "wayfarer_traveler_yard_after_v4_640x360", Vector2(416, 460), NO_PLAYER, GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Connected traveler working yard"),
		_evidence_spec(5, "wayfarer_rest_grove_after_v4_640x360", Vector2(704, 460), NO_PLAYER, GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Rest grove, road approach, and 05"),
		_evidence_spec(6, "wayfarer_north_lawn_after_v4_640x360", Vector2(704, 180), NO_PLAYER, GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Open north lawn and transition sightline"),
		_evidence_spec(7, "wayfarer_road_transitions_after_v4_640x360", Vector2(704, 320), NO_PLAYER, GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Road dominance and north/east transition readability"),
		_evidence_spec(8, "wayfarer_05_player_front_after_v4_640x360", Vector2(704, 460), Vector2(880, 578), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Player below and in front of 05"),
		_evidence_spec(9, "wayfarer_05_player_behind_after_v4_640x360", Vector2(704, 460), Vector2(880, 516), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Player above and behind 05"),
		_evidence_spec(10, "wayfarer_07_player_front_after_v4_640x360", Vector2(640, 420), Vector2(650, 526), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Player below and in front of 07"),
		_evidence_spec(11, "wayfarer_07_player_behind_after_v4_640x360", Vector2(640, 420), Vector2(650, 462), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Player above and behind 07"),
		_evidence_spec(12, "wayfarer_primary_display_after_v4_1280x720", Vector2(704, 400), NO_PLAYER, GAMEPLAY_SIZE, DISPLAY_SIZE, "Exact nearest-neighbor 2x primary gameplay view"),
	]
	...
	var manifest := {
		"schema": "caden-wayfarer-production-landscape-screenshot-manifest-v4",
		"scope": "Wayfarer's Approach production landscape pass; no other zone or library candidate.",
		...
		"reproduction": {
			"godot_arguments": "--path <repository> --rendering-method gl_compatibility --script res://tools/art/render_caden_wayfarer_production_landscape_v4.gd -- --output-root <absolute-directory-outside-res>",
	...
	var manifest_path := _output_root.path_join("wayfarer_production_landscape_screenshot_manifest_v4.json")
...
func _resolve_output_root() -> String:
	...
	return OS.get_environment("CADEN_WAYFARER_LANDSCAPE_OUTPUT_ROOT")
