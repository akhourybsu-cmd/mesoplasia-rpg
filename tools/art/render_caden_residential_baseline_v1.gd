...
const RENDER_TOOL_PATH := "res://tools/art/render_caden_residential_baseline_v1.gd"
...
func _render() -> void:
	...
	var specs: Array[Dictionary] = [
		_spec("residential_full_zone_before_v1_1152x768", Vector2(576, 384), NO_PLAYER, FULL_ZONE_SIZE, FULL_ZONE_SIZE, "Untouched Residential full-zone contract"),
		_spec("residential_west_arrival_before_v1_640x360", Vector2(320, 384), Vector2(128, 384), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Town Square arrival and primary west-east route"),
		_spec("residential_primary_route_before_v1_640x360", Vector2(576, 384), Vector2(576, 384), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Primary route and Commons junction"),
		_spec("residential_north_homes_before_v1_640x360", Vector2(576, 208), NO_PLAYER, GAMEPLAY_SIZE, GAMEPLAY_SIZE, "North home footprints and lanes"),
		_spec("residential_south_homes_before_v1_640x360", Vector2(576, 592), NO_PLAYER, GAMEPLAY_SIZE, GAMEPLAY_SIZE, "South home footprints and Commons approach"),
		_spec("residential_commons_transition_before_v1_640x360", Vector2(576, 588), Vector2(576, 640), GAMEPLAY_SIZE, GAMEPLAY_SIZE, "Commons exit and arrival marker clearance"),
		_spec("residential_primary_display_before_v1_1280x720", Vector2(576, 384), Vector2(576, 384), GAMEPLAY_SIZE, DISPLAY_SIZE, "Exact nearest-neighbor 2x primary view"),
	]
	...
	var manifest := {
		"schema": "caden-residential-baseline-screenshot-manifest-v1",
		"scope": "Untouched Residential Quarter reconstruction baseline.",
		...
		"reproduction": {
			"godot_arguments": "--path <repository> --rendering-method gl_compatibility --script res://tools/art/render_caden_residential_baseline_v1.gd -- --output-root <absolute-directory-outside-res>",
			"notes": "Every view instantiates the untouched live Residential scene. The 1280x720 frame is nearest-neighbor resized from its native 640x360 capture state.",
		},
		"captures": entries,
	}
	var manifest_path := _output_root.path_join("residential_baseline_screenshot_manifest_v1.json")
...
func _resolve_output_root() -> String:
	...
	return OS.get_environment("CADEN_RESIDENTIAL_BASELINE_OUTPUT_ROOT")
